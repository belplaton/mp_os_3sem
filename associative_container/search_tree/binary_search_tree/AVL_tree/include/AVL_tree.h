...
// Если факторы по знаку совпадают, то делаем малый поворот, а если разные, то большой
//  A (h:3,f:2)
//   \
//    B (h:2,f:-1)
//   /
//  C (h:1,f:0)
// Пускай мы добавили C, обновляя высоты у нод мы идем к корню. Видим, что у корня A и дочерного B
// Разные знаки факторов. А потому делаем большой левый поворот
//     B (h:2,f:0)
//    / \
//   A   C
//
